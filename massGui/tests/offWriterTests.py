...
def runOffWriterForTests():
    ...
    with open(os.path.join(basedir,r'DataForTests', r'20200107_Realtime', r'20200107_run0002_chan1.off'), 'wb'):
        pass #clear the destination file
    with open(os.path.join(basedir,r"DataForTests", r"Source", r"20200107", r"0002", r"20200107_run0002_chan1.off"), 'rb') as source_off_file:
        first = True
